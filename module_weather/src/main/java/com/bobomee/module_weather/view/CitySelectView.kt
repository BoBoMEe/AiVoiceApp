package com.bobomee.module_weather.view
...
class CitySelectView : View {
    ...
    //选中的文本颜色
    private var checkTextColor = Color.BLUE

    //未选中的文本颜色
    private val unCheckTextColor = Color.WHITE
    ...
    private fun initView() {
        //蓝色
        checkTextColor = context.resources.getColor(R.color.color_main_blue)
        //抗锯齿
