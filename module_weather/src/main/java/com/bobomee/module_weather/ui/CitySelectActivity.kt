package com.bobomee.module_weather.ui
...
import com.bobomee.module_weather.R
import com.bobomee.module_weather.data.CitySelectBean
import com.bobomee.module_weather.view.CitySelectView
...
class CitySelectActivity : BaseActivity() {
    ...
    private fun setHotCityView(mCityHotView: RecyclerView) {
        ...
        mCityHotView.adapter = CommonAdapter(cityList.toList(), object :
